                ...
                <>
                    <nav id="mobileNav">
                        <div className="mobile-container">
                            ...
                            <span className="mobile-close"><a href="#" className="mobile-close-btn"><img src="./images/btn_gnb_close.png" alt="button"/></a></span>
                            ...
                            <div className="container2">
                                <div className="slide-container">
                                    ...
                                    <div className="page-btn-box">
                                        <span><a href="#" className="play-btn on" title="Play & Stop"><img src="./images/main_prom_stop.png" alt="stop"/></a></span>
                                        <span><a href="#" className="page-btn" title="page1"><img src="./images/main_prom_on.png" alt="page1"/></a></span>
                                        <span><a href="#" className="page-btn" title="page2"><img src="./images/main_prom_off.png" alt="page2"/></a></span>
                                        <span><a href="#" className="page-btn" title="page3"><img src="./images/main_prom_off.png" alt="page3"/></a></span>
                                    </div>
                                </div>
                            </div>
                        </div>      
